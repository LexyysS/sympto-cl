...
const Diagnosis = ({ diagnosis }) => {
  ...
  useEffect(() => {
      const diagnosisElement = diagnosisRef.current;

      if (diagnosisElement) {
          diagnosisElement.scrollIntoView({ behavior: 'smooth' });
      }
  }, []);
  ...
  return (
    <div className="w-full h-full ">
      {diagnosis && (
        <div className="w-full h-full ">
          <h2 ref={diagnosisRef} id="diagnosis" className="font-bold text-2xl text-sky-900">Diagnóstico</h2>
