          ...
          <>
            <div className="w-full h-full mt-5 flex md:flex-row flex-col gap-1">
              ...
              <div className="w-full md:w-1/2 h-full  p-5 rounded-lg ">
                ...
                <button
                  ...
                  className="w-full bg-blue-500 hover:bg-blue-700 text-white cursor-pointer mt-5 rounded-lg p-2 disabled:cursor-default disabled:bg-gray-300"
            ...
            <div className="w-full  p-5 mt-5 rounded-lg ">
              {isValid ? (
                ...
                <h2 className="font-bold text-2xl"> Esperando resultados</h2>
              )}
            </div>
          </>
        )}
